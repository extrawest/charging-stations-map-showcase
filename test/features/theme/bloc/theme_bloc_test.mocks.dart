...
// in maps_app/test/features/theme/bloc/theme_bloc_test.dart.
...
class MockBox<E> extends _i1.Mock implements _i2.Box<E> {
  ...
  @override
  _i3.Future<Iterable<int>> addAll(
    Iterable<E>? values, {
    bool? notify = true,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<int> clear({bool? notify = true}) => (super.noSuchMethod(
        Invocation.method(
          #clear,
          [],
          {#notify: notify},
