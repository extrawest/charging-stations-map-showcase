...
mixin _$WalletState {
  ...
  WalletModel? get model => throw _privateConstructorUsedError;
...
abstract class $WalletStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, Failure? failure, WalletModel? model});

  $WalletModelCopyWith<$Res>? get model;
}
...
class _$WalletStateCopyWithImpl<$Res, $Val extends WalletState>
  ...
  $WalletModelCopyWith<$Res>? get model {
    ...
    return $WalletModelCopyWith<$Res>(_value.model!, (value) {
...
class _$_WalletState implements _WalletState {
  const _$_WalletState(
      {required this.isLoading, required this.failure, required this.model});
  ...
  @override
  String toString() {
    return 'WalletState(isLoading: $isLoading, failure: $failure, model: $model)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, failure, model);
...
abstract class _WalletState implements WalletState {
  const factory _WalletState(
      ...
      required final WalletModel? model}) = _$_WalletState;
